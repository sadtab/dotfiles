    ...
    opts = {
        ...
        keymaps = {
            ...
            view = {
                ...
                { "n", "<tab>", '<cmd>lua require("diffview.actions").select_next_entry()<CR>',
                    { desc = "Select the next entry" } },
                { "n", "<S-tab>", '<cmd>lua require("diffview.actions").select_prev_entry()<CR>',
                    { desc = "Select the previous entry" } },
